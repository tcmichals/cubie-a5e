...
#ifdef CONFIG_OOB
static u32 oobcfg_tbl_8800dc_sdio_u02[][2] = {
...
static u32 patch_tbl_wifisetting_8800dc_u01[][2] = {{0x010c, 0x01001E01}};
...
static const u32 txgain_map_h[96] = {
	// 11b
	0xffd888, // 11
	0xffd979, // 12
	0xffd988, // 13
