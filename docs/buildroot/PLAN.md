...
- [x] Standardized on Linux Mainline `remoteproc` framework via [`sunxi_rproc.c`](HowToRISCV.md), ensuring robust in-kernel lifecycle management.
...
- [ ] Verify execution of vector table and CRT0 in Dedicated SRAM_A3 (`0x40000000` / `0x40040000`).
