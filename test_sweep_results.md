...
| Profile 4 | run_tests.py (Dual Mailbox Suite) | **FAIL** |
| Profile 4 | test_dual_msgbox.py (DSP + E907 Concurrent) | **FAIL** |
...
| ping_rpmsg.py (Python VirtIO) | **PASS** | 1000/1000 | N/A | 6,166.4 msgs/s | 770.8 KB/s | PASS (0 errors) |
...
| ping_rpmsg.py (Python SRAM VirtIO) | **PASS** | 1000/1000 | N/A | 7,272.6 msgs/s | 909.1 KB/s | PASS (0 errors) |
...
| ping_uio.py (Python UIO Doorbell) | **PASS** | 1000/1000 | 180.34 µs | 4,459.6 msgs/s | None | PASS (0 errors) |
...
| Test / Application | Status | Packets | Avg RTT | Throughput | Bandwidth | Data Integrity |
| :--- | :---: | :---: | :---: | :---: | :---: | :--- |
| testMsgbox (E907 Mailbox Ch 8/9) | **PASS** | 100/100 | 142.61 µs | 7,012.2 msgs/s | 27.39 KB/s | PASS (0 errors) |
| dsp-testMsgbox (DSP Mailbox Ch 4/5) | **FAIL** | 0/100 | N/A | N/A | N/A | Verified |
| Dual: DSP-HiFi4 (Ch 4/5) | **FAIL** | 0/1000 | N/A | N/A | N/A | Verified |
| Dual: E907-RISCV (Ch 8/9) | **PASS** | 1000/1000 | 135.64 µs | 7,372.2 msgs/s | 28.80 KB/s | PASS (0 errors) |
